...
var Iput = {
    ...
    drice: function (e) {
        ...
        if (Iput.get(Iput.confg.idIframe)) {
            if (Iput.confg.hand == "1") {
                top = Iput.confg.top + document.getElementById("city").scrollTop + document.documentElement.scrollTop + e.clientY;
                left = Iput.confg.left + e.clientX + document.getElementById("city").scrollLeft + document.documentElement.scrollLeft;
    ...
    colse: function () {
        if (Iput.get(Iput.confg.idIframe)) {
            document.getElementById("city").removeChild(Iput.get(Iput.confg.idBox));
            document.getElementById("city").removeChild(Iput.get(Iput.confg.idIframe));
        }
